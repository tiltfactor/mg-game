...
// New model extending BaseUser for facebook users
...
class FacebookUser extends BaseUser
{
    ...
    public function rules() {
        return array(
            ...
            //     array('role', 'checkRoleAccess'),   //pkostov problem here
    ...
    public function search() {
        ...
        $criteria->compare('open_id', $this->open_id, true); // pkostov
    ...
    public function checkRoleAccess($attribute,$params) {
        if (!Yii::app()->authManager->isAssigned($this->role, Yii::app()->user->id) && Yii::app()->user->id == $this->id)  // When  Yii::app()->user->id is set => the user is logged in
