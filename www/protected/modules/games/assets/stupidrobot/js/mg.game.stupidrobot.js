MG_GAME_STUPIDROBOT = function ($) {
    return $.extend(MG_GAME_API, {
        ...
        idx_introText: ["Meet Stupid Robot.",
            ...
            "Can you help?",
            "Using words at least 4 letters long, tell the robot what is in each image.",
            "Stupid Robot wants to learn one word about the image of every length.",
            "It wants to learn a 4 letter word, a 5 letter word, a 6 letter word, etc.",
            "Once you've taught it a word of one length, try a longer or shorter word.",
            "Sometimes Stupid Robot has never seen your word ever before.",
            "When this happens, Stupid Robot learns that word for next time.",
            "Try another word of that length until Stupid Robot understands.",
