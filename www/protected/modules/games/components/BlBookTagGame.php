<?php
/**
 * Implementation of the needed methods for British Library Book Tag
 *
 * @package    MG
 * @author     Vincent Van Uffelen <novazembla@gmail.com>
 */
class BlBookTagGame extends MGGame implements MGGameInterface
{
    ...
    public function parseTags(&$game, &$game_model)
    {
        ...
        foreach ($game->request->submissions as $submission) {
            ...
            // the submission has in the case of British Library Book Tag just one media and a
