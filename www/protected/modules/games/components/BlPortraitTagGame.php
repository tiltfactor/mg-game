<?php
/**
 * Implementation of the needed methods for British Library Portrait Tag
 *
 * @package    MG
 * @author     Vincent Van Uffelen <novazembla@gmail.com>
 */
class BlPortraitTagGame extends MGGame implements MGGameInterface
{
    ...
    public function parseTags(&$game, &$game_model)
    {
        ...
        foreach ($game->request->submissions as $submission) {
            ...
            // the submission has in the case of British Library Portrait Tag just one media and a
