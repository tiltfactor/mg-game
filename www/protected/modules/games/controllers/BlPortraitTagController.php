...
class BlPortraitTagController extends GxController
{
  ...
  public function actionIndex() {
    ...
    $game = GamesModule::loadGame("BlPortraitTag");
    if ($game) {
      $cs = Yii::app()->clientScript;
      $cs->registerCoreScript('jquery');
      $cs->registerCssFile(Yii::app()->baseUrl . '/css/jquery.fancybox-1.3.4.css');
      $cs->registerCssFile(GamesModule::getAssetsUrl() . '/blportraittag/css/style.css');
      ...
      $cs->registerScriptFile(GamesModule::getAssetsUrl() . '/blportraittag/js/mg.game.zentag.js', CClientScript::POS_END);
...
EOD;
  ...
  public function actionView() {
    $model = $this->loadModel(array("unique_id" => "BlPortraitTag"), 'BlPortraitTag');  
    $model->fbvLoad();
  ...
  public function actionUpdate() {
    ...
    if (isset($_POST['BlPortraitTag'])) {
      $model->setAttributes($_POST['BlPortraitTag']);
      
      $relatedData = array(
        'collections' => $_POST['BlPortraitTag']['collections'] === '' ? null : $_POST['BlPortraitTag']['collections'],
        'plugins' => $_POST['BlPortraitTag']['plugins'] === '' ? null : $_POST['BlPortraitTag']['plugins'],
        );
