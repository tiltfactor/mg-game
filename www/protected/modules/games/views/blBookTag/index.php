<div id="gamearea">
  ...
  <div id="stage">
    ...
    <div id="holder">
      ...
      <img class="magnify" src="<?php echo GamesModule::getAssetsUrl(); ?>/blbooktag/images/magnify.png" alt="" />
    </div>
    <!-- user text field -->
...
<div id="dark-footer">
  <img src="<?php echo GamesModule::getAssetsUrl(); ?>/blbooktag/images/logo_tiltfactor.png" alt="Tiltfactor" />
  <img src="<?php echo GamesModule::getAssetsUrl(); ?>/blbooktag/images/logo_dartmouth.png" alt="Dartmouth" />
  <img src="<?php echo GamesModule::getAssetsUrl(); ?>/blbooktag/images/logo_acls.png" alt="ACLS" />
  <img src="<?php echo GamesModule::getAssetsUrl(); ?>/blbooktag/images/logo_neh.png" alt="National Endowment for the Humanities" />
</div>
