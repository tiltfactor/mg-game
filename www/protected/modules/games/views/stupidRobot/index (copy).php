<div id="splash_home">
    <input type="hidden" id="game_uri" value="<?php echo Yii::app()->baseUrl; ?>/index.php/games/StupidRobot/" />
    ...
    <div id="stage">
        ...
        <div class="content" id="content">
            <div class="main_screen" id="main_screen">
                ...
                <div class="text_left">
                    <a href="<?php echo $game_url; ?>/StupidRobot/play" class="hover_btn">
            ...
            <div id="login" class="text-center index_screen hidden">
                <form>
                    <div class="logo"><img src="<?php echo GamesModule::getAssetsUrl(); ?>/stupidRobot/images/splash_logo.png" /></div>
                    <div class="button">
                    ...
                    <div id="facebook"><img src="<?php echo GamesModule::getAssetsUrl(); ?>/stupidRobot/images/facebook.png" /></div>
                </form>
            </div>
        ...
        <nav id="menu-right" style="visibility: hidden;">
            <ul>
                ...
                <li class="back_blue row" id="mmenuPlay"><div><a href="<?php echo Yii::app()->baseUrl; ?>/index.php/games/StupidRobot/play/"><span>PLAY</span></a></div></li>
