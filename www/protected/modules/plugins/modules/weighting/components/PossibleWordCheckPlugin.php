...
class PossibleWordCheckPlugin extends MGWeightingPlugin
{
    ...
    function score(&$game_model, &$tags, $score)
    {
        ...
        // This does NOT catch cases like Qatar...use wordcheck.py in conjuction
        // with this if needed
        $python_file = Yii::getPathOfAlias('ext.nlp.python') . DIRECTORY_SEPARATOR .
            "nlpserver" . DIRECTORY_SEPARATOR . "scripts" . DIRECTORY_SEPARATOR . 
            "possible_wordcheck" . DIRECTORY_SEPARATOR . "possible_wordcheck.py";
        $is_word = "";
